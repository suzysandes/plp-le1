...
public class Exp1Parser implements Exp1ParserConstants {
  public static void main(String args [])
  {
    ...
    if (args.length == 0)
    {
      ...
      parser = new Exp1Parser(System.in); // Parser obtem tokens do analisador léxico    }
  ...
  static final public Valor PValorChar() throws ParseException {
   Token token;
    token = jj_consume_token(CHAR_LITERAL);
      String tokenStr = token.toString();
      Character tokenChar = tokenStr.charAt(0);
      {if (true) return new ValorChar(tokenChar);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Expressao PExpAscii() throws ParseException {
   Expressao retorno;
    ...
    retorno = PExpPrimaria();
     if (retorno instanceof ValorChar)
     {
       ValorChar val = (ValorChar) retorno;
     }
     {if (true) return new ExpAscii(retorno);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x6000,0x316000,0x2316000,0x231f800,0x0,0x400,0x400,0x200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x20000,0x200,0x38000,0x38000,0x0,};
   }
